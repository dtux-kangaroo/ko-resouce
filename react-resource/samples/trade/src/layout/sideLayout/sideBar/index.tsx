              ...
              <SubMenu key={item.permissionUrl} title={<span><Icon type="mail" /><span>{item.permissionName}</span></span>}>
                {
                  item.children.map((dataItem) => (
                    dataItem.children.length?<SubMenu key={dataItem.permissionUrl} title={<span><Icon type={dataItem.permissionIcon} /><span>{item.permissionName}</span></span>}>
                      {
